...
open class JInventoryHeldByCustomer : AbstractRoutine<Int>("inventory_held_by_customer", JSakila.SAKILA, SQLDataType.INTEGER) {
    ...
    init {
        returnParameter = JInventoryHeldByCustomer.RETURN_VALUE
        addInParameter(JInventoryHeldByCustomer.P_INVENTORY_ID)
    }

    /**
     * Set the <code>p_inventory_id</code> parameter IN value to the routine
     */
    fun setPInventoryId(value: Int?): Unit = setValue(JInventoryHeldByCustomer.P_INVENTORY_ID, value)
    ...
    fun setPInventoryId(field: Field<Int?>): JInventoryHeldByCustomer {
        setField(JInventoryHeldByCustomer.P_INVENTORY_ID, field)
        return this
    }
}
