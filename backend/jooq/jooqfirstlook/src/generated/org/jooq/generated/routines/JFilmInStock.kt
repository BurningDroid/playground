...
open class JFilmInStock : AbstractRoutine<java.lang.Void>("film_in_stock", JSakila.SAKILA) {
    companion object {
    ...
    init {
        addInParameter(JFilmInStock.P_FILM_ID)
        addInParameter(JFilmInStock.P_STORE_ID)
        addOutParameter(JFilmInStock.P_FILM_COUNT)
    }

    /**
     * Set the <code>p_film_id</code> parameter IN value to the routine
     */
    fun setPFilmId(value: Int?): Unit = setValue(JFilmInStock.P_FILM_ID, value)

    /**
     * Set the <code>p_store_id</code> parameter IN value to the routine
     */
    fun setPStoreId(value: Int?): Unit = setValue(JFilmInStock.P_STORE_ID, value)

    /**
     * Get the <code>p_film_count</code> parameter OUT value from the routine
     */
    fun getPFilmCount(): Int? = get(JFilmInStock.P_FILM_COUNT)
}
