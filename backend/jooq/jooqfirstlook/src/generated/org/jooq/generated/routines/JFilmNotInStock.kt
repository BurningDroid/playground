...
open class JFilmNotInStock : AbstractRoutine<java.lang.Void>("film_not_in_stock", JSakila.SAKILA) {
    ...
    init {
        addInParameter(JFilmNotInStock.P_FILM_ID)
        addInParameter(JFilmNotInStock.P_STORE_ID)
        addOutParameter(JFilmNotInStock.P_FILM_COUNT)
    }

    /**
     * Set the <code>p_film_id</code> parameter IN value to the routine
     */
    fun setPFilmId(value: Int?): Unit = setValue(JFilmNotInStock.P_FILM_ID, value)

    /**
     * Set the <code>p_store_id</code> parameter IN value to the routine
     */
    fun setPStoreId(value: Int?): Unit = setValue(JFilmNotInStock.P_STORE_ID, value)

    /**
     * Get the <code>p_film_count</code> parameter OUT value from the routine
     */
    fun getPFilmCount(): Int? = get(JFilmNotInStock.P_FILM_COUNT)
}
