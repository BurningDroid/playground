...
open class JStaffList(
    ...
    companion object {
         ...
         */
        val STAFF_LIST: JStaffList = JStaffList()
    }
    ...
    override fun `as`(alias: String): JStaffList = JStaffList(DSL.name(alias), this)
    override fun `as`(alias: Name): JStaffList = JStaffList(alias, this)
    override fun `as`(alias: Table<*>): JStaffList = JStaffList(alias.qualifiedName, this)

    /**
     * Rename this table
     */
    override fun rename(name: String): JStaffList = JStaffList(DSL.name(name), null)

    /**
     * Rename this table
     */
    override fun rename(name: Name): JStaffList = JStaffList(name, null)

    /**
     * Rename this table
     */
    override fun rename(name: Table<*>): JStaffList = JStaffList(name.qualifiedName, null)

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Condition?): JStaffList = JStaffList(qualifiedName, if (aliased()) this else null, condition)

    /**
     * Create an inline derived table from this table
     */
    override fun where(conditions: Collection<Condition>): JStaffList = where(DSL.and(conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(vararg conditions: Condition?): JStaffList = where(DSL.and(*conditions))

    /**
     * Create an inline derived table from this table
     */
    override fun where(condition: Field<Boolean?>?): JStaffList = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(condition: SQL): JStaffList = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String): JStaffList = where(DSL.condition(condition))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg binds: Any?): JStaffList = where(DSL.condition(condition, *binds))

    /**
     * Create an inline derived table from this table
     */
    @PlainSQL override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): JStaffList = where(DSL.condition(condition, *parts))

    /**
     * Create an inline derived table from this table
     */
    override fun whereExists(select: Select<*>): JStaffList = where(DSL.exists(select))

    /**
     * Create an inline derived table from this table
     */
    override fun whereNotExists(select: Select<*>): JStaffList = where(DSL.notExists(select))
}
