...
open class JInventoryInStock : AbstractRoutine<Byte>("inventory_in_stock", JSakila.SAKILA, SQLDataType.TINYINT) {
    ...
    init {
        returnParameter = JInventoryInStock.RETURN_VALUE
        addInParameter(JInventoryInStock.P_INVENTORY_ID)
    }

    /**
     * Set the <code>p_inventory_id</code> parameter IN value to the routine
     */
    fun setPInventoryId(value: Int?): Unit = setValue(JInventoryInStock.P_INVENTORY_ID, value)
    ...
    fun setPInventoryId(field: Field<Int?>): JInventoryInStock {
        setField(JInventoryInStock.P_INVENTORY_ID, field)
        return this
    }
}
